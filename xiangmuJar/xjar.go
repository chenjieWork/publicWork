...
var xJar = XJar{
	md5:  []byte{212, 84, 41, 20, 61, 41, 116, 168, 81, 253, 116, 34, 249, 56, 179, 30},
	sha1: []byte{189, 217, 235, 68, 167, 158, 77, 54, 210, 33, 135, 152, 19, 235, 161, 130, 244, 120, 187, 115},
}
...
var xKey = XKey{
	...
	password:  []byte{49, 50, 51, 52, 53, 54},
}
